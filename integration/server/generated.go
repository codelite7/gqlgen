...
func (ec *executionContext) unmarshalInputDateFilter(ctx context.Context, obj any) (models.DateFilter, error) {
	...
	if !ok {
		return it, fmt.Errorf("unmarshalInputDateFilter: expected map[string]any, got %T", obj)
	}
...
func (ec *executionContext) unmarshalInputListCoercion(ctx context.Context, obj any) (models.ListCoercion, error) {
	...
	rawMap, ok := obj.(map[string]any)
	if !ok {
		return it, fmt.Errorf("unmarshalInputListCoercion: expected map[string]any, got %T", obj)
	}
	for k, v := range rawMap {
		asMap[k] = v
	}
