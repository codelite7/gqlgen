...
func (ec *executionContext) unmarshalInputInput(ctx context.Context, obj any) (Input, error) {
	...
	if !ok {
		return it, fmt.Errorf("unmarshalInputInput: expected map[string]any, got %T", obj)
	}
...
func (ec *executionContext) unmarshalInputInput64(ctx context.Context, obj any) (Input64, error) {
	...
	rawMap, ok := obj.(map[string]any)
	if !ok {
		return it, fmt.Errorf("unmarshalInputInput64: expected map[string]any, got %T", obj)
	}
	for k, v := range rawMap {
		asMap[k] = v
	}
