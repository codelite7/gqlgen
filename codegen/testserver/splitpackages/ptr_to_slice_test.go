...
// Ported from codegen/testserver/singlefile/ptr_to_slice_test.go: exercises
// the $type.IsPtrToSlice marshal branch (the split codec's PtrToSliceContainer
// field is bound to *[]string, same as singlefile's hand-written model).
